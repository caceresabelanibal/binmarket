...
class FakeExecutionProvider(ExecutionProvider):
    ...
    def __init__(self, fill_price: float = 100.0, should_fail: bool = False, balance: float = 10_000.0):
    ...
    def place_market_order(self, symbol: str, side: str, quantity: float) -> ExecutionResult:
        ...
        return ExecutionResult(True, OrderStatus.FILLED, None, quantity, self.fill_price, commission, "USDT")
